...
namespace MyGame
{
    ...
    public class BloomFirstStage
    {
        ...
        {
            mDownsampleShader = new Shader("Bloom/shadersBloom/bloom.vert", "Bloom/shadersBloom/downscale.frag");
            mUpsampleShader = new Shader("Bloom/shadersBloom/bloom.vert", "Bloom/shadersBloom/upscale.frag");
            Ghost = new Texture("Resources/img/bokeh_circle.png")
            {
                PixelInternFormat = PixelInternalFormat.Rgba
            };
